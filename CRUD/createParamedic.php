...
//////////////////////////////////////////////////////////////////////////////////////////////////
					...
					// Execute query
					$stmt -> execute([$_POST["EmployeeID"], $_POST["AmbID"], $_POST["LName"], $_POST["Fname"], "Paramedic"]);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
				...
				redirect("createParamedic.php");
		}
	}
	else {
//////////////////////////////////////////////////////////////////////////////////////////////////
					// Create a form that will post to this page: createPeople.php
					//
					...
					echo "<center>";
					echo "<form action = 'createParamedic.php' method='post'>";
					...
					echo "</center>";
					echo "<p><input type = \"submit\" name = \"submit\" value = \"Add Paramedic\" class=\"button tiny round\" />";
					echo "</form>";
